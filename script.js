const startBtn = document.getElementById("start-btn");
    ...
    const spiritProfiles = {
      Kroot: { name: "Kroot", img: "images/kroot.png", ability: "Helps you feel heard and safe.", personality: "Sarcastic but secretly soft-hearted.", friend: "Bitty", enemy: null },
      Banion: { name: "Banion", img: "images/banion.png", ability: "Helps you release pent-up emotions.", personality: "Emotional, warm, intuitive.", friend: "Mubii", enemy: "Onyun" },
      Potatoad: { name: "Potatoad", img: "images/potatoad.png", ability: "Teaches you that rest is valid.", personality: "Chill, adorable, sleepy.", friend: "Onyun", enemy: null },
      Mubii: { name: "Mubii", img: "images/mubii.png", ability: "Repels toxic vibes.", personality: "Quiet protector.", friend: "Gingeer", enemy: null },
      Onyun: { name: "Onyun", img: "images/onyun.png", ability: "Fiercely loyal, protects your heart.", personality: "Reactive, barky, loyal.", friend: "Potatoad", enemy: "Banion" },
      Bitty: { name: "Bitty", img: "images/bitty.png", ability: "Sparks hope through humor.", personality: "Small, cheerful, sensitive.", friend: "Kroot", enemy: "Gingeer" },
      Gingeer: { name: "Gingeer", img: "images/gingeer.png", ability: "Gives clarity and calm wisdom.", personality: "Wise, warm, realistic.", friend: "Mubii", enemy: "Bitty" }
    };
    ...
    function renderQuestion() {
      ...
      `;
      const optDiv = box.querySelector(".options");
